  ...
  projectsFrontend: [
    {
      ...
      image: "${process.env.PUBLIC_URL}/MyPortfolioSite.png" // Картинка должна лежать в папке public
    },
    {
      id: 2,
      ...
      image: "${process.env.PUBLIC_URL}/Marcus_Studio.png" // Картинка должна лежать в папке public
    },
    {
      id: 3,
      title: "Tattoo Studio",
      ...
      image: "${process.env.PUBLIC_URL}/Tattoo_Studio.png" // Картинка должна лежать в папке public
    }
    // Сюда легко добавить второй проект в будущем:
    // { id: 2, title: "Next Project", ... }
  ],
